        ...
        <div class="container-fluid" id="side-menu">
            ...
            <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
                <div class="offcanvas-header" id="dash">
                    ...
                    <h1 id="navheader" class="ms-2">SCHEDULE</h1>
                </div>
...
<div class="modal fade" id="deleteTaskModal" tabindex="-1" aria-labelledby="deleteTaskModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="deleteData.php" method="post" id="deleteTaskForm">
                    <input type="hidden" name="taskID" id="deleteTaskID">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                    <button type="submit" name="deleteTask" class="btn btn-danger">Delete Task</button>
                </form>
            </div>
        </div>
    </div>
...
<script>
    // JavaScript to set the task ID for deletion
    $('#deleteTaskButton').on('click', function() {
        var taskID = $('#taskID').val(); // Adjust this according to your actual task ID field
